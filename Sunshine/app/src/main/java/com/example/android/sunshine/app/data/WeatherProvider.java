...
public class WeatherProvider extends ContentProvider {
    ...
    // this class helps construct queries
    ...
    public String getType(Uri uri) {
        ...
        // personal note: the "s" prefix means that the data is of type String
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;
                    // CONTENT_ITEM_TYPE only returns a single row
            // 2.)
            case WEATHER_WITH_LOCATION:
                return WeatherContract.WeatherEntry.CONTENT_TYPE;
                    // CONTENT_TYPE returns multiple records, which is a directory
            case WEATHER:
                return WeatherContract.WeatherEntry.CONTENT_TYPE;
            case LOCATION:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        return rowsDeleted;
        // NOTE: We do NOT want to close the database here
        // do not use db.close in this function or the update function
...
//    }
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        final int match = sUriMatcher.match(uri);
        switch (match) {
            // WEATHER transactions are the only transactions we insert in bulk
            case WEATHER:
                db.beginTransaction();
                int returnCount = 0;
                try {
